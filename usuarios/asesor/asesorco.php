                ...
                <div class="container center12">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="panel">
                                    <a href="asesor/agregarcli.php"><div><button type="button" class="btn btn-blue tam1">Crear Clientes</button></div></a>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="panel">
                                    <a href="asesor/vercliente.php"><div><button type="button" class="btn btn-blue tam1">Ver Clientes</button></div></a>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="panel">
                                    <a href="activar/activarclient.php"><div><button type="button" class="btn btn-blue tam1">Activar Clientes</button></div></a>
                                </div>
                            </div>
                        </div>
                    </div> 
