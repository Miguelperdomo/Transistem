        ...
        <div class="row">
            ...
            <main class="main col">
                <div class="row justify-content-center align-content-center text-center">
                    ...
                    $sql= "SELECT * FROM usuarios, rol, solicitud where usuarios.id_usu = solicitud.id_usu and usuarios.id_rol=rol.id_rol and usuarios.id_usu=$busca"; 
                    $resultado=$base->prepare($sql);
                    $resultado->execute(array());
                    $regusu=$resultado->fetch(PDO::FETCH_ASSOC);

                    
                    if($regusu){
                            echo '<br><div class="alert alert-danger center4"> No se puede eliminar este cliente, asociado a solicitud.
                            </div><br>
                            <div class="container">
                            ...
                            $sql= "SELECT * FROM usuarios where id_usu = $busca"; 
                            $resultado=$base->prepare($sql);
                            $resultado->execute(array());
                            ...
                            try{
                                if(isset($_POST['eliminar'])){
                                    ...
                                    $resultado->execute(array(":id"=>$user));//asigno las variables a los marcadores
                                    echo '<script>alert("Haz Eliminado este elemento.");</script>';
                                    echo '<script>window.location= "../vercliente.php"</script>';
                                }
			            ?>
                            ...
                            <form method="post">
                                <div class="col-auto">
                                    <div class="input-group col">
                                        ...
                                        <input type="text" class="form-control" readonly name="idr" value="<?php echo $users['id_usu']?>">
                                    </div>
                                </div>
                                <br>
                                <div class="col-auto">
                                    <div class="input-group col ">
                                        ...
                                        <input type="text" class="form-control" readonly name="nom" value="<?php echo $users['nom_usu']?>">
                                    </div>
                                </div>

                                <br>                               
                                <div class="modal-footer">
                                    <a href="vercliente.php"><button type="button" class="btn btn-secondary">Cancelar</button></a>
