<?php
  ...
  /* Obteniendo datos de la BD. */
    $regis=$base->query("SELECT * from usuarios, rol, estado where usuarios.id_rol=rol.id_rol and usuarios.id_est=estado.id_est and usuarios.id_rol=5 and usuarios.id_est=1 LIMIT $empieza, $regis")->fetchALL(PDO::FETCH_OBJ);
            ...
            <main class="main col">
                <div class="row justify-content-center align-content-center text-center">
                    <div class="col-sm-12" id="title">
                        <h3 class="mb-0 ">Clientes Registrados Activos</h3>
                    </div>
                </div>
                <br>
                <div class="container">
                    ...
                    <a href="impricliente.php"><button type="button" onClick="window.print()" class="btn btn-info"><i class="fa-solid fa-print"></i></button></a>
                                        ...
                                        <?php
                                            for($i=0; $i<$paginas; $i++):?>
                                                <li class="page-item <?php echo $pagina==$i+1? 'active': ''?>">
                                                    <a class="page-link" 
                                                    href="vercliente.php?pagina=<?php echo $i+1?>">
                                                <?php echo $i+1?></a>
                                                </li>
                                                <?php endfor?>
