        ...
        <div class="row">
            ...
            <?php
                ...
                try{
                    ...
                    $sql="SELECT  * from servicios where id_ser=:id";//consulta con marcador, el marcador es :codigo
                    ...
                    $resultado->execute(array(":id"=>$busca));
                        ...
                        if($ser=$resultado->fetch(PDO::FETCH_ASSOC)){
                                    ...
                                    <form method="post" action="validar.php">
                                        <div class="col-auto">
                                            <div class="input-group col">
                                                ...
                                                <input type="text" class="form-control" readonly name="id" value="<?php echo $ser['id_ser']?>">
                                            </div>
                                        </div>
                                        <br>
                                        <div class="col-auto">
                                            <div class="input-group col ">
                                                ...
                                                <input type="text" class="form-control" name="servi" value="<?php echo $ser['servi']?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-auto">
                                            <div class="input-group col ">
                                                ...
                                                <input type="number" class="form-control" name="tari" value="<?php echo $ser['tarifa']?>">
                                            </div>
                                        </div>
                                        <br>                                
                                        <div class="col-10">
                                            <input class="btn btn-blue"  type="submit" name="insert" value="Guardar" >
                                            <a href="../servicio.php"><button type="button" class="btn btn-secondary">Cancelar</button></a>
                                        </div>
                                    </form>
                                </div>
                            </div>
            ...
            </main> <!-- /* scripts que se utiliza para hacer la página más interactiva */ -->
