            ...
            <main class="main col">
                <div class="row justify-content-center align-content-center text-center">
                    <div class="col-sm-9" id="title">
                        <h3 class="mb-0 ">Eliminar Servicios</h3>
                    </div>
                    <br>
            <?php
                ...
                try{
                   ...
                   $sql= "SELECT * FROM solicitud where id_ser = :de"; 
                   $resultado=$base->prepare($sql);
                   ...
                   if($usu){
                       ...
                       <div class="container">
                           <a href="../servicio.php"><button type="button" class="btn btn-secondary">Volver</button></a>
                       </div>';
                   }
                   else{

                       $sql= "SELECT * FROM servicios where id_ser = $busca"; 
                       $resultado=$base->prepare($sql);
                       $resultado->execute(array());
                       $ser=$resultado->fetch(PDO::FETCH_ASSOC);   
                                ...
                                <form method="post">
                                    <div class="col-auto">
                                        <div class="input-group col">
                                            ...
                                            <input type="text" class="form-control" readonly name="idr" value="<?php echo $ser['id_ser']?>">
                                        </div>
                                    </div>
                                    <br>
                                    <div class="col-auto">
                                        <div class="input-group col ">
                                            ...
                                            <input type="text" class="form-control" readonly name="rol" value="<?php echo $ser['servi']?>">
                                        </div>
                                    </div>
                                    <br>                                
                                    <div class="col-10">
