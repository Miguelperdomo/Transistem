                                ...
                                <table id="tablaRoles" class="table table-striped table-bordered table-condensed center3" style="width:50%">
                                    ...
                                    <tbody class="text-center">
                                        ...
                                        <tr class="table-light" >
                                            ...
                                            <td>
                                                <a href="identi/edit.php?id=<?php echo $ident->id_ident?> & nom=<?php echo $ident->ident?>"><button type="button" class="btn btn-sm btn-blue"><i class="fa-solid fa-pen-to-square"></i></button></a>
                                            </td>
                                            <td>
                                                <a href="identi/delete.php?id=<?php echo $ident->id_ident?> & nom=<?php echo $ident->ident?>"><button type="button" class="btn btn-sm btn-danger"> <i class="fa-solid fa-trash-can"></i></button></a>
                                            </td>
                                        </tr>
                                        <?php
                                        endforeach;
