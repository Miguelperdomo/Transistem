            ...
            <main class="main col">
                <div class="row justify-content-center align-content-center text-center">
                    <div class="col-sm-9" id="title">
                        <h3 class="mb-0 ">Editar Tipos de Clientes</h3>
                    </div>
                    <br>
                    <?php
                ...
                $busca=$_GET["id"];
                    ...
                    try{
                        ...
                        $sql="SELECT  * from tipo_cliente  where  id_tip_clien=:id";//consulta con marcador, el marcador es :codigo
                        ...
                        if($cliente=$resultado->fetch(PDO::FETCH_ASSOC)){
                                    ...
                                    <form method="post" action="validedit.php">
                                        ...
                                        <div class="col-auto">
                                            <div class="input-group col ">
                                                ...
                                                <input type="text" class="form-control"  name="tip" value="<?php echo $cliente['tip_clien']?>">
                                            </div>
                                         </div>
                                        <br>                           
                    ...
                    <?php
                            ...
                            echo "No existe ese Tipo vehiculo $busca";
                        }
