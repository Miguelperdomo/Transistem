        ...
        <div class="row">
            ...
            <div class="barra-lateral col-12 col-sm-auto">
                <nav class="menu d-flex d-sm-block justify-content-center flex-wrap" >
                    ...
                    <a href="../../sistema.php"><i class="fa-solid fa-clipboard"></i><span>Gestiónar Sistema</span></a>
                </nav>
            </div>
            <!--Contenido principal-->
            <main class="main col">
                <div class="row justify-content-center align-content-center text-center">
                    <div class="col-sm-9" id="title">
                        <h3 class="mb-0 ">Eliminar Tipo Cliente</h3>
                    </div>
                    <br>
                    <?php
	                $busca=$_GET["id"];
                    ...
                    try{
                        ...
                        $sql= "SELECT * FROM usuarios where id_tip_clien = :de"; 
                        $resultado=$base->prepare($sql);
                        ...
                        if($usu){
                            ...
                            <div class="container">
                                <a href="../tipcli.php"><button type="button" class="btn btn-secondary">Volver</button></a>
                            </div>';
                        }
                        else{

                            $sql= "SELECT * FROM tipo_cliente where id_tip_clien = $busca"; 
                            $resultado=$base->prepare($sql);
                            $resultado->execute(array());
                            $cliente=$resultado->fetch(PDO::FETCH_ASSOC);   

                            $id=$cliente['id_tip_clien'];

                            if(isset($_POST['eliminar'])){

                                $sql="DELETE FROM tipo_cliente WHERE id_tip_clien=:id";
                                ...
                                <form method="post">
                                    <div class="col-auto">
                                        <div class="input-group col">
                                            ...
                                            <input type="text" class="form-control" readonly name="idr" value="<?php echo $cliente['id_tip_clien']?>">
                                        </div>
                                    </div>
                                    <br>
                                    <div class="col-auto">
                                        <div class="input-group col ">
                                            ...
                                            <input type="text" class="form-control" readonly name="tip" value="<?php echo $cliente['tip_clien']?>">
                                        </div>
                                    </div>
                                    <br>                              
                                    <div class="modal-footer">
                                        <a href="../tipcli.php"><button type="button" class="btn btn-secondary">Cancelar</button></a>
                    ...
                    $resultado->closeCursor();
	                   ...
	                   /* Mensaje que se muestra cuando el usuario intenta borrar un registro que está
                        ...
                        <div class="container">
                            <a href="../tipclie.php"><button type="button" class="btn btn-secondary">Volver</button></a>
                        </div>');
                    }finally{
