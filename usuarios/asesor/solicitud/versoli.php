<?php
  ...
  /* Obteniendo datos de la BD. */
    $regis=$base->query("SELECT * from solicitud, usuarios, servicios, estado where solicitud.id_usu=usuarios.id_usu and solicitud.id_ser=servicios.id_ser and solicitud.id_est = estado.id_est and solicitud.id_est=5 LIMIT $empieza, $regis")->fetchALL(PDO::FETCH_OBJ);
?>
        ...
        <div class="row">
            ...
            <main class="main col">
                ...
                <div class="container">
                    ...
                    <!-- Botones Reportes  -->
                    <a href="soli/reporteapro.php"><button class="btn btn-success"><i class="fa-solid fa-file-excel"></i> Excel</button></a>
                    <a href="soli/versolipdf.php" target="blank"><button class="btn btn-danger"><i class="fa-solid fa-file-pdf"></i></button></a>
                    <a href="impriversoli.php"><button type="button"  class="btn btn-info"><i class="fa-solid fa-print"></i></button></a>                   
                    <br> <br> 
                                       <!-- Filtro -->
                                ...
                                <table id="tablaRoles" class="table table-striped table-bordered table-condensed" style="width:100%">
                                    ...
                                    <tbody class="text-center" id="myTable">
                                        ...
                                        <tr class="table-light" >
                                            ...
                                            <td>
                                                <a href="ver.php?id=<?php echo $solicitud->id_soli?> & idn=<?php echo $solicitud->id_usu?>"><button type="button" class="btn btn-sm btn-primary"><i class="fa-solid fa-magnifying-glass"></i></button></a>
                                            </td>
                                        </tr>
                                        <?php
                                        endforeach;
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination justify-content-center">
                                        <li class="page-item <?php echo $pagina<=1? 'disabled' : '' ?>">
                                                <a class="page-link" href="versoli.php?pagina=<?php echo $pagina-1 ?>">Anterior</a>
                                        </li>
                                        <li class="page-item <?php  echo $pagina>=$paginas? 'disabled' : '' ?> "><a class="page-link" href="versoli.php?pagina=<?php echo $pagina+1 ?>">Siguiente</a></li>
                                    </ul>
                                </nav> 
                            </div>
                        </div>
