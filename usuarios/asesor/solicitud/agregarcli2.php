...
if(isset($_POST['insert'])){
   ...
   /* Comprobar si los campos están vacíos. */
    if (empty($_POST['tip']) || empty($_POST['ident']) || empty($_POST['nom']) || empty($_POST['clave']) || empty($_POST['dir']) || empty($_POST['tel']) || empty($_POST['emai'])){
        ...
        header("Location: crearsoli.php?id=$usu");
    }
...
<head>
    ...
    <script>
        ...
        alert("Cliente no registrado, Registralo ahora.")
    </script>
<body>
    <!--Barra cabecera-->
            ...
            <main class="main col">
                <div class="row justify-content-center align-content-center text-center">
                    ...
                    <div class="container center4">
                        <form method="post" action="" id="form" autocomplete="off" enctype="multipart/form-data" >
                            <br>
                            <div class="col-auto">
                            ...
                            <div class="col-auto">
                                <div class="input-group col">
                                    ...
                                    <input type="number"  class="form-control" name="doc" readonly value="<?php echo $ver ?>">
                                </div>
                            ...
                            <div class="col-auto">
                                <div class="input-group col ">
                                    ...
                                    <select class="custom-select" name="est">
                                            <?php
                                            $sql= "SELECT * FROM estado WHERE id_est = 1"; 
                                            $resultado=$base->prepare($sql);
                                            $resultado->execute(array());
                            ...
                            <div class="modal-footer">
                                <a href="buscarcli.php"><button type="button" class="btn btn-secondary">Cancelar</button></a>
