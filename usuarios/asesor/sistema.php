...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="main col">
                <div class="container">
                    <img src="../../img/config.png" alt="usu" width="150px" class="center2">
                </div>
                <br><br><br>
                <div class="container">
                 <!-- /* Un div que contiene otones que redirigen a otras páginas */ -->
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <div class="panel">
                                    <a href="sistema/iden.php"><div><button type="button" class="btn btn-blue tam1">Identificación</button></div></a>
                                </div>
                            </div>
                            <div class="col">
                                <div class="panel">
                                    <a href="sistema/servicio.php"><div><button type="button" class="btn btn-blue tam1">Servicios</button></div></a>
                                </div>
                            </div>
                            <div class="col">
                                <div class="panel">
                                    <a href="sistema/tipcli.php"><div><button type="button" class="btn btn-blue tam1">Tipo personas</button></div></a>
                                </div>
                            </div>
                        </div>
                    </div> 
