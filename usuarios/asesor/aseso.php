            ...
            <div class="col-4 text-right barra">
                <ul class="navbar-nav mr-auto">
                    <li>
                        ...
                        <a class="px-3 text-light perfil dropdown-toggle" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo (' <img src="../../fotos/'.$usu.'"  width="40" height=40" class="mr-3 rounded-circle img-thumbnail shadow-sm"> ')?></a>
        ...
        <div class="row">
            ...
            <div class="barra-lateral col-12 col-sm-auto">
                <nav class="menu d-flex d-sm-block justify-content-center flex-wrap" >
                    <a href="asesorco.php"><i class="fa-sharp fa-solid fa-bus"></i><span>Inicio</span></a>
