<?php
   ...
   /* Importar la clase IOFactory de la librería PhpSpreadsheet. */
    ...
    $sql="SELECT * from usuarios, rol, estado, tipo_cliente, ident where usuarios.id_rol=rol.id_rol and usuarios.id_est=estado.id_est and usuarios.id_tip_clien=tipo_cliente.id_tip_clien and usuarios.id_ident=ident.id_ident and usuarios.id_rol=4 and usuarios.id_est=2";
 ...
 /* Crear una nueva hoja de cálculo y establecer la hoja activa en la primera hoja. */
    ...
    $hojaActiva->setTitle("Conductores Inactivos");
...
// Redirigir el archivo de salida al navegador del cliente
    ...
    header('Content-Disposition: attachment;filename="conduact.xlsx"');
