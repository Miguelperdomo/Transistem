<?php
    ...
    /* Este es el código que se ejecuta cuando el usuario pulsa sobre el botón "Activar"*/
    if(isset($_POST['activar'])){
        ...
        echo '<script>alert("Haz Actualizado este Cliente a Activo.");</script>';
            ...
            <main class="main col">
                <div class="row justify-content-center align-content-center text-center">
                    <div class="col-sm-9" id="title">
                        <h3 class="mb-0 ">Activar Cliente</h3>
                    </div>
                    <br>
