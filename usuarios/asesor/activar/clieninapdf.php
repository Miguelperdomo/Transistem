<?php
    ...
    $reg=$base->query("SELECT * from usuarios, rol, estado, tipo_cliente, ident where usuarios.id_rol=rol.id_rol and usuarios.id_est=estado.id_est and usuarios.id_tip_clien=tipo_cliente.id_tip_clien and usuarios.id_ident=ident.id_ident and usuarios.id_rol=4 and usuarios.id_est=2")->fetchALL(PDO::FETCH_OBJ);
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="main col">
                ...
                <br>
                <h4 class="text-center">Conductores Inactivos</h4>
                <br>
                <div class="container">
                    <div class="row">
...
<?php
    ...
    $dompdf->stream("conduact.pdf", array("Attachment" => false)); //Abre el archivo, pero en el navegador(false - no descarga)
?>