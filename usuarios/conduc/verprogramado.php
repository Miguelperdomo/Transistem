...
/* Traemos las conexiones con la base de datos y la session star para la validacion de que se loguie y traiga las variables globales y la fecha y hora */
   ...
   /* Unir las tablas y seleccionar los datos de las tablas. */
    $sql="SELECT * from detalle_ord, orden_ser, solicitud, usuarios, servicios, estado, rutas, origen, destino, ciudad, detalle_vehi where detalle_ord.id_soli=orden_ser.id_soli and detalle_ord.id_est=estado.id_est and orden_ser.id_soli=solicitud.id_soli and solicitud.id_usu=usuarios.id_usu and solicitud.id_ser=servicios.id_ser and solicitud.id_ruta = rutas.id_ruta and rutas.id_origen=origen.id_origen and rutas.id_destino=destino.id_destino and destino.id_ciudad=ciudad.id_ciudad and detalle_ord.id_detave=detalle_vehi.id_detave and orden_ser.id_soli = $soli";
   ...
   /* Selección de la ciudad de origen de la base de datos. */
        ...
        <div class="row">
            ...
            <main class="main col">
                ...
                <div class="container center4">
                    ...
                    <!-- campos de entrada de formulario que es de solo lectura.-->
                        ...
                        <div class="modal-footer">
                            <!-- Encontramos los botones de devolver -->
                            <a href="verprogra.php"><button type="button" class="btn btn-secondary">Volver</button></a>
                        </div>
                    </form>
                </div>
            </main>
