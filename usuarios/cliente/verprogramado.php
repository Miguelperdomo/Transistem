...
<?php
    ...
    /* Consulta a las tablas y seleccion de los datos necesarios para mostrar los datos. */
     $sql="SELECT * from detalle_ord, orden_ser, solicitud, usuarios, servicios, estado, rutas, origen, destino, ciudad, detalle_vehi where detalle_ord.id_soli=orden_ser.id_soli and detalle_ord.id_est=estado.id_est and orden_ser.id_soli=solicitud.id_soli and solicitud.id_usu=usuarios.id_usu and solicitud.id_ser=servicios.id_ser and solicitud.id_ruta = rutas.id_ruta and rutas.id_origen=origen.id_origen and rutas.id_destino=destino.id_destino and destino.id_ciudad=ciudad.id_ciudad and detalle_ord.id_detave=detalle_vehi.id_detave and detalle_ord.id_detaord = $busca";
     $resultado=$base->prepare($sql);
     $resultado->execute(array());
                     ...
                     <form method="POST" action="">
                         ...
                         <div class="row">
                             ...
                             <div class="col">
                                 <div class="input-group mb-3">
                                     <div class="input-group-prepend">
                                         <span class="input-group-text" id="basic-addon1"><strong>Capacidad</strong></span>
                                     </div>
                                     <input type="number" class="form-control text-center" readonly name="capa" value="<?php echo $vehi['capaci_pasa']?>">
                                 </div>
                             </div>
                         </div>
                         <div class="modal-footer">
                           
                             <a href="verordpro.php?id=<?php echo $solicitud['id_soli']; ?> & auto=<?php echo $solicitud['id_auto']; ?>"><button type="button" class="btn btn-secondary">Volver</button></a>
                         </div>
                     </form>
                 </div>
             </main>
