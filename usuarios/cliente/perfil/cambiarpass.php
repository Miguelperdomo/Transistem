...
/* Comprobando si el formulario ha sido enviado. */
    if(isset($_POST['enviar'])){
      ...
      /* Obtener la contraseña de la base de datos y compararla con la contraseña ingresada por el
       usuario. */
     ...
     /* Redirigir al usuario a la misma página si la contraseña es incorrecta. */
        } else {
        ...
        <div class="row">
            ...
            <div class="barra-lateral col-12 col-sm-auto">
                ...
                <nav class="menu d-flex d-sm-block justify-content-center flex-wrap" >
                    ...
                    <a href="../estadosoli.php"><i class="fa-solid fa-screwdriver-wrench"></i><span>Estado de
                            Solicitudes</span></a>
                    <a href="../contrato.php"><i class="fa-solid fa-screwdriver-wrench"></i><span>Contratos
                            Generados</span></a>
                </nav>
            </div>
            <!--Contenido principal-->
