            ...
            <main class="main col">
                <div class="row justify-content-center align-content-center text-center">
                    ...
                    try{
                        ...
                        $sql= "SELECT * FROM usuarios where id_rol = :de"; 
                        $resultado=$base->prepare($sql);
                        $resultado->execute(array(":de" => $busca));
                        $usu=$resultado->fetch(PDO::FETCH_ASSOC);

                        if($usu){
                            echo '<br><div class="alert alert-danger center4"> No se puede eliminar este Rol. Asociado a usuario.
                            </div><br>
                            <div class="container">
                            ...
                            $sql= "SELECT * FROM rol where id_rol = $busca"; 
                            $resultado=$base->prepare($sql);
                            $resultado->execute(array());
                            $rols=$resultado->fetch(PDO::FETCH_ASSOC);   
                            ...
                            if(isset($_POST['eliminar'])){
                                ...
                                $resultado->execute(array(":id"=>$ro));//asigno las variables a los marcadores
                                ...
                                <form method="post">
                                    <div class="col-auto">
                                        <div class="input-group col">
                                            ...
                                            <input type="text" class="form-control" readonly name="idr" value="<?php echo $rols['id_rol']?>">
                                        </div>
                                    </div>
                                    <br>
                                    <div class="col-auto">
                                        <div class="input-group col ">
                                            ...
                                            <input type="text" class="form-control" readonly name="rol" value="<?php echo $rols['rol']?>">
                                        </div>
                                    </div>
                                    <br>                                
                                    <div class="col-10">
                                        <a href="../roles.php"><button type="button" class="btn btn-secondary">Cancelar</button></a>
                    ...
                    <?php
	                    ...
	                    die('<br><div class="alert alert-danger center4"> No se puede eliminar este Rol.
                            </div><br>
                            <div class="container">
                            <a href="../roles.php"><button type="button" class="btn btn-secondary">Volver</button></a>
                            </div>');
