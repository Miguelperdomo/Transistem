        ...
        <div class="row">
            ...
            <main class="main col">
                ...
                $busca=$_GET["id"];
                    ...
                    $sql="SELECT  * from rol  where  id_rol=:id";//consulta con marcador, el marcador es :codigo
                    ...
                    $resultado->execute(array(":id"=>$busca));
                        ...
                        if($rol=$resultado->fetch(PDO::FETCH_ASSOC)){
                                    ...
                                    <form method="post" action="validar.php">
                                        <div class="col-auto">
                                            <div class="input-group col">
                                                ...
                                                <input type="text" class="form-control" readonly name="idr" value="<?php echo $rol['id_rol']?>">
                                            </div>
                                        </div>
                                        <br>
                                        <div class="col-auto">
                                            <div class="input-group col ">
                                                ...
                                                <input type="text" class="form-control" name="rol" value="<?php echo $rol['rol']?>">
                                            </div>
                                        </div>
                                        <br>                                
                                        <div class="col-10">
