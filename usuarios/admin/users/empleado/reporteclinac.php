<?php
 ...
 /* Importar las clases necesarias para crear la hoja de cálculo.. */
    ...
    $sql="SELECT * from usuarios, rol, estado, tipo_cliente, ident where usuarios.id_rol=rol.id_rol and usuarios.id_est=estado.id_est and usuarios.id_tip_clien=tipo_cliente.id_tip_clien and usuarios.id_ident=ident.id_ident and usuarios.id_est=2";
...
header('Content-Disposition: attachment;filename="clienInact.xls"');
