<?php
    ...
    $reg=$base->query("SELECT * from usuarios, rol, estado, tipo_cliente, ident where usuarios.id_rol=rol.id_rol and usuarios.id_est=estado.id_est and usuarios.id_tip_clien=tipo_cliente.id_tip_clien and usuarios.id_ident=ident.id_ident and usuarios.id_est=2")->fetchALL(PDO::FETCH_OBJ);
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="main col">
                ...
                <div class="container">
                    <div class="row">
                       <!-- Un botón que llama a la función de impresión -->
                        <a href=""><button type="button" onClick="window.print()" class="btn btn-info"><i class="fa-solid fa-print"></i></button></a>
