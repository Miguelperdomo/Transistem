...
require_once("../../../../connections/connection.php");
   ...
   $usu = $reg["foto"];
     ...
     if(isset($_POST['insert'])){
        ...
        if (empty($_POST['doc']) || empty($_POST['tip']) || empty($_POST['ident']) || empty($_POST['nom']) || empty($_POST['cla']) || empty($_POST['est']) || empty($_POST['dir']) || empty($_POST['tel']) || empty($_POST['emai'])){
       
            echo '<script>alert ("Campos vacios. Por favor diligencie todos los campos.");</script>'; 
    
        }else{
            /* Toma los valores del formulario y asignarlos a variables. */
            $usu=$_POST['doc'];
            $rol=$_POST['rol'];
            $tipo=$_POST['tip'];
            $ide=$_POST['ident'];
            ...
            /* comprobar si el usuario existe en la base de datos. Si lo hace, alertará al usuario de que el
            usuario ya existe y lo redirigirá a la página de inicio de sesión. */
            if($regi){
                ...
                <div class="row justify-content-center align-content-center text-center">
                    ...
                    <form method="post" action="" enctype="multipart/form-data" id="form" autocomplete="off">
                            ...
                            <div class="col-auto">
                                ...
                                <center><small>El Teléfono debe tener mas de 7 números </small></center>
                            </div>
                            <br>
                            <div class="col-auto">
                                <div class="input-group col ">
                                ...
                                <center><small>Correo debe ser válido.</small></center>
                            </div>
                            <br>
                            <div class="col-auto">
                                <div class="input-group col ">
