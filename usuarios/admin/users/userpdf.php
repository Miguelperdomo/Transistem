<?php
    ...
    ob_start();//Llenar el buffer o la memoria
    

    require_once("../../../connections/connection.php"); 

    $reg=$base->query("SELECT * from usuarios, rol, estado, tipo_cliente, ident where usuarios.id_rol=rol.id_rol and usuarios.id_est=estado.id_est and usuarios.id_tip_clien=tipo_cliente.id_tip_clien and usuarios.id_ident=ident.id_ident and usuarios.id_rol=5 and usuarios.id_est=1")->fetchALL(PDO::FETCH_OBJ);
 ?>
...
<?php
    /* Obtener el contenido de la memoria y asignarlo a la variable  ``. */
