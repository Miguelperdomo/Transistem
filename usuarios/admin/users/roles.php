...
if(isset($_POST['insert'])){
    ...
    $sql="INSERT INTO rol (id_rol, rol) values (:id, :ro)";
    $resultado=$base->prepare($sql);
...
$regis = 4;
  ...
  /* Obtención de datos de la base de datos. */
    $regis=$base->query("SELECT * from rol LIMIT $empieza, $regis")->fetchALL(PDO::FETCH_OBJ);
?>
                                        ...
                                        <form method="post" autocomplete="off">
                                            <div class="col-auto">
                                                <div class="input-group col">
                                                    ...
                                                    <input type="number" required class="form-control" name="idr" >
                                                </div>
                                            </div>
                                            <br>
                                            <div class="col-auto">
                                                <div class="input-group col ">
                                                    ...
                                                    <input type="text" required class="form-control" name="rol" >
                                                </div>
                                            </div>
                                            <br>                                
                            ...
                            <div class="table-responsive ">        
                                <table id="tablaRoles" class="table table-striped table-bordered table-condensed center3" style="width:50%">
                                    ...
                                    <tbody class="text-center">
                                        <?php
                                            foreach ($regis as $rol):
                                        ?> 
                                        <tr class="table-light" >
                                            <td><?php echo $rol->id_rol?></td>
                                            <td><?php echo $rol->rol?></td>
                                            <td>
                                                <a href="roles/edit.php?id=<?php echo $rol->id_rol?> & nom=<?php echo $rol->rol?>"><button type="button" title="Eliminar" class="btn btn-sm btn-blue"><i class="fa-solid fa-pen-to-square"></i></button></a>
                                            </td>
                                            <td>
                                                <a href="roles/delete.php?id=<?php echo $rol->id_rol?> & nom=<?php echo $rol->rol?>"><button type="button" title="Editar" class="btn btn-sm btn-danger"> <i class="fa-solid fa-trash-can"></i></button></a>
                                            </td>
                                        </tr>
                                        <?php
                                        endforeach;
