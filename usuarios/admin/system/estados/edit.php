        ...
        <div class="row">
            ...
            <?php
                ...
                try{
                    ...
                    $sql="SELECT  * from estado where id_est=:id";//consulta con marcador, el marcador es :codigo

                    $resultado=$base->prepare($sql);//el objeto $base llama al metodo prepare que recibe por parametro la instrucción sql, se almacena en la variable resultado.
                    $resultado->execute(array(":id"=>$busca));

                        if($est=$resultado->fetch(PDO::FETCH_ASSOC)){
                                    ...
                                    <form method="post" action="validar.php">
                                        ...
                                        <div class="col-auto">
                                            <div class="input-group col ">
                                                ...
                                                <input type="text" class="form-control" name="est" value="<?php echo $est['tip_est']?>">
                                            </div>
                                        </div>
                                        <br>                                
                                        <div class="col-10">
