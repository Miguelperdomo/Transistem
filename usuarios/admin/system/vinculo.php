...
$regis = 4;
    if(isset($_GET["pagina"])){
       /* Redirigir al usuario a la página vinculo.php si el usuario está en la página 1 */
        if($_GET["pagina"]==1){
            header("Location:vinculo.php");
        }else{
            $pagina=$_GET["pagina"];
                                ...
                                <table id="tablaRoles" class="table table-striped table-bordered table-condensed center3" style="width:50%">
                                    ...
                                    <tbody class="text-center">
                                        ...
                                        <tr class="table-light" >
                                            ...
                                            <td>
                                                <a href="vinculo/edit.php?id=<?php echo $vinculos->id_tip_vincu?>"><button type="button" class="btn btn-sm btn-blue"><i class="fa-solid fa-pen-to-square"></i></button></a>
                                            </td>
                                            <td>
                                                <a href="vinculo/delete.php?id=<?php echo $vinculos->id_tip_vincu?>"><button type="button" class="btn btn-sm btn-danger"> <i class="fa-solid fa-trash-can"></i></button></a>
                                            </td>
                                        </tr>
                                        <?php
                                        endforeach;
