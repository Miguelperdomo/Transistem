...
<body>
        ...
        <div class="row">
            ...
            <div class="barra-lateral col-12 col-sm-auto">
                <nav class="menu d-flex d-sm-block justify-content-center flex-wrap" >
                    ...
                    <a href="../../users.php"><i class="fa-solid fa-address-book"></i><span>Gidentión Usuarios</span></a>
                    <a href="../../system.php"><i class="fa-solid fa-screwdriver-wrench"></i><span>Gidentión Sistema</span></a>
            ...
            <main class="main col">
                <div class="row justify-content-center align-content-center text-center">
                    <div class="col-sm-9" id="title">
                        <h3 class="mb-0 ">Editar identificación</h3>
                    </div>
                    <br>
            <?php
                ...
                try{
                    ...
                    $sql="SELECT  * from ident where id_ident=:id";//consulta con marcador, el marcador es :codigo
                    ...
                    $resultado->execute(array(":id"=>$busca));
                        ...
                        if($ident=$resultado->fetch(PDO::FETCH_ASSOC)){
                                    ...
                                    <form method="post" action="validar.php">
                                        <div class="col-auto">
                                            <div class="input-group col">
                                                ...
                                                <input type="text" class="form-control" readonly name="id" value="<?php echo $ident['id_ident']?>">
                                            </div>
                                        </div>
                                        <br>
                                        <div class="col-auto">
                                            <div class="input-group col ">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">ident</div>
                                                </div>
                                                <input type="text" class="form-control" name="ident" value="<?php echo $ident['ident']?>">
                                            </div>
                                        </div>
                                        <br>                                
                                        <div class="col-10">
                                            <input class="btn btn-blue"  type="submit" name="insert" value="Guardar" >
                                            <a href="../iden.php"><button type="button" class="btn btn-secondary">Cancelar</button></a>
                                        </div>
                                    </form>
                                </div>
                            </div>
    ...
    <script src="roles/app.js"></script>
</body>
