            ...
            <main class="main col">
                <div class="row justify-content-center align-content-center text-center">
                    <div class="col-sm-9" id="title">
                        <h3 class="mb-0 ">Eliminar identificación</h3>
                    </div>
                    <br>
            <?php
                ...
                $busca=$_GET["id"];
	             try{
                    ...
                    $sql= "SELECT * FROM usuarios where id_ident = :de"; 
                    $resultado=$base->prepare($sql);
                    ...
                    if($usu){
                        ...
                        <div class="container">
                            <a href="../iden.php"><button type="button" class="btn btn-secondary">Volver</button></a>
                        </div>';
                    }
                    else{

                        $sql= "SELECT * FROM ident where id_ident = $busca"; 
                        $resultado=$base->prepare($sql);
                        $resultado->execute(array());
                        $ident=$resultado->fetch(PDO::FETCH_ASSOC);   

                        $id=$ident['id_ident'];

                        if(isset($_POST['eliminar'])){

                            $sql="DELETE FROM ident WHERE id_ident=:id";
                                ...
                                <form method="post">
                                    ...
                                    <div class="col-auto">
                                        <div class="input-group col ">
                                            ...
                                            <input type="text" class="form-control" readonly name="ident" value="<?php echo $ident['ident']?>">
                                        </div>
                                    </div>
                                    <br>                                
                                    <div class="col-10">
