            ...
            <main class="main col">
                <div class="row justify-content-center align-content-center text-center">
                    <div class="col-sm-9" id="title">
                        <h3 class="mb-0 ">Eliminar Modelo</h3>
                    </div>
                    <br>
            <?php
	             $busca=$_GET["id"];
                 ...
                 try{
                     ...
                     $sql= "SELECT * FROM regis_veh where id_modelo = :de"; 
                     $resultado=$base->prepare($sql);
                    ...
                    /* Mensaje que se muestra cuando el usuario intenta borrar un registro que está
                     ...
                     if($ele){
                         ...
                         <div class="container">
                             <a href="../modelo.php"><button type="button" class="btn btn-secondary">Volver</button></a>
                         </div>';
                     }
                     else{

                         $sql= "SELECT * FROM modelo where id_modelo = $busca"; 
                         $resultado=$base->prepare($sql);
                         $resultado->execute(array());
                         $mode=$resultado->fetch(PDO::FETCH_ASSOC);   
                         ...
                         if(isset($_POST['eliminar'])){
                            ...
                            echo '<script>alert("Haz Eliminado este Modelo.");</script>';
                                ...
                                <form method="post">
                                    <div class="col-auto">
                                        <div class="input-group col">
                                            ...
                                            <input type="text" class="form-control" readonly name="id" value="<?php echo $mode['id_modelo']?>">
                                        </div>
                                    </div>
                                    <br>
                                    <div class="col-auto">
                                        <div class="input-group col ">
                                            ...
                                            <input type="text" class="form-control" readonly name="mode" value="<?php echo $mode['modelo']?>">
                                        </div>
                                    </div>
                                    <br>                                
                                    <div class="col-10">
                                        <a href="../modelo.php"><button type="button" class="btn btn-secondary">Cancelar</button></a>
