            ...
            <main class="main col">
                <div class="row justify-content-center align-content-center text-center">
                    <div class="col-sm-9" id="title">
                        <h3 class="mb-0 ">Eliminar Vínculo</h3>
                    </div>
                    <br>
                    <?php
	                $busca=$_GET["id"];
                    ...
                    try{
                        ...
                        $sql= "SELECT * FROM regis_veh where id_tip_vincu = :de"; 
                        $resultado=$base->prepare($sql);
                        ...
                        if($ele){
                            ...
                            <div class="container">
                                <a href="../vinculo.php"><button type="button" class="btn btn-secondary">Volver</button></a>
                            </div>';
                        }
                        else{

                            $sql= "SELECT * FROM vinculo where id_tip_vincu = $busca"; 
                            $resultado=$base->prepare($sql);
                            $resultado->execute(array());
                            $vin=$resultado->fetch(PDO::FETCH_ASSOC);   

                            $ro=$vin['id_tip_vincu'];

                            if(isset($_POST['eliminar'])){

                                $sql="DELETE FROM vinculo WHERE id_tip_vincu=:id";
                                ...
                                <form method="post">
                                    <div class="col-auto">
                                        <div class="input-group col">
                                            ...
                                            <input type="text" class="form-control" readonly name="idr" value="<?php echo $vin['id_tip_vincu']?>">
                                        </div>
                                    </div>
                                    <br>
                                    <div class="col-auto">
                                        <div class="input-group col ">
                                            ...
                                            <input type="text" class="form-control" readonly name="vin" value="<?php echo $vin['vinculo']?>">
                                        </div>
                                    </div>
                                    <br>                            
