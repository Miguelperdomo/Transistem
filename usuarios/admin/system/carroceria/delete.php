            ...
            <main class="main col">
                <div class="row justify-content-center align-content-center text-center">
                    <div class="col-sm-9" id="title">
                        <h3 class="mb-0 ">Eliminar Carrocería</h3>
                    </div>
                    <br>
            <?php
               ...
               try{
                ...
                $sql= "SELECT * FROM regis_veh where id_carroce = :de"; 
                $resultado=$base->prepare($sql);
                ...
                if($ele){
                    ...
                    <div class="container">
                        <a href="../carroce.php"><button type="button" class="btn btn-secondary">Volver</button></a>
                    </div>';
                }
                else{

                    $sql= "SELECT * FROM carroceria where id_carroce = $busca"; 
                    $resultado=$base->prepare($sql);
                    $resultado->execute(array());
                    $car=$resultado->fetch(PDO::FETCH_ASSOC);   

                    $id=$car['id_carroce'];

                    if(isset($_POST['eliminar'])){

                        $sql="DELETE FROM carroceria WHERE id_carroce=:id";
                                ...
                                <form method="post">
                                    <div class="col-auto">
                                        <div class="input-group col">
                                            ...
                                            <input type="text" class="form-control" readonly name="idr" value="<?php echo $car['id_carroce']?>">
                                        </div>
                                    </div>
                                    <br>
                                    <div class="col-auto">
                                        <div class="input-group col ">
                                            ...
                                            <input type="text" class="form-control" readonly name="rol" value="<?php echo $car['carroceria']?>">
                                        </div>
                                    </div>
                                    <br>                                
                                    <div class="col-10">
                                        <a href="../carroce.php"><button type="button" class="btn btn-secondary">Cancelar</button></a>
