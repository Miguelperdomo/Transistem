            ...
            <main class="main col">
                <div class="row justify-content-center align-content-center text-center">
                    <div class="col-sm-9" id="title">
                        <h3 class="mb-0 ">Editar Carrocerías</h3>
                    </div>
                    <br>
            <?php
                ...
                try{
                    ...
                    $sql="SELECT  * from carroceria where id_carroce=:id";//consulta con marcador, el marcador es :codigo
                    ...
                    $resultado->execute(array(":id"=>$busca));
                        ...
                        if($car=$resultado->fetch(PDO::FETCH_ASSOC)){
                                    ...
                                    <form method="post" action="validar.php">
                                        <div class="col-auto">
                                            <div class="input-group col">
                                                ...
                                                <input type="text" class="form-control" readonly name="id" value="<?php echo $car['id_carroce']?>">
                                            </div>
                                        </div>
                                        <br>
                                        <div class="col-auto">
                                            <div class="input-group col ">
                                                ...
                                                <input type="text" class="form-control" name="car" value="<?php echo $car['carroceria']?>">
                                            </div>
                                        </div>
                                        <br>                                
                                        <div class="col-10">
