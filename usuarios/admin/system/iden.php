...
if(isset($_POST['insert'])){
    ...
    $sql="INSERT INTO ident (id_ident, ident) values (:id, :idn)";
    $resultado=$base->prepare($sql);
    $resultado->execute(array(":id"=>$id, ":idn"=>$ident));
...
$regis = 4;
    ...
    $regis=$base->query("SELECT * from ident LIMIT $empieza, $regis")->fetchALL(PDO::FETCH_OBJ);
?>
            ...
            <main class="main col">
                <div class="row justify-content-center align-content-center text-center">
                    <div class="col-sm-9" id="title">
                        <h3 class="mb-0 ">Tipo de identificaciones</h3>
                    </div>
                    <br>
                    <!-- Modal Insertar -->
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Añadir identificación</h5>
                                            ...
                                            <div class="col-auto">
                                                <div class="input-group col ">
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text">Tipo identificación</div>
                                                    </div>
                                                    <input type="text" required class="form-control" name="idn" >
                                                </div>
                                            </div>
                                            <br>                                
                            ...
                            <div class="table-responsive "> 
                                ...
                                <table id="tablaRoles" class="table table-striped table-bordered table-condensed center3" style="width:50%">
                                    ...
                                    <tbody class="text-center">
                                        <?php
                                            foreach ($regis as $ident):
                                        ?> 
                                        <tr class="table-light" >
                                            <td><?php echo $ident->id_ident?></td>
                                            <td><?php echo $ident->ident?></td>
                                            <td>
                                                <a href="identi/edit.php?id=<?php echo $ident->id_ident?>"><button type="button" class="btn btn-sm btn-blue"><i class="fa-solid fa-pen-to-square"></i></button></a>
                                            </td>
                                            <td>
                                                <a href="identi/delete.php?id=<?php echo $ident->id_ident?>"><button type="button" class="btn btn-sm btn-danger"> <i class="fa-solid fa-trash-can"></i></button></a>
                                            </td>
                                        </tr>
                                        <?php
                                        endforeach;
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-center">
                        <li class="page-item <?php echo $pagina<=1? 'disabled' : '' ?>">
                                <a class="page-link" href="iden.php?pagina=<?php echo $pagina-1 ?>">Anterior</a>
                        </li>
                        <?php
                            for($i=0; $i<$paginas; $i++):?>
                                <li class="page-item <?php echo $pagina==$i+1? 'active': ''?>">
                                    <a class="page-link" 
                                    href="iden.php?pagina=<?php echo $i+1?>">
                                <?php echo $i+1?></a>
                                </li>
                                <?php endfor?>
                        <li class="page-item <?php  echo $pagina>=$paginas? 'disabled' : '' ?> "><a class="page-link" href="iden.php?pagina=<?php echo $pagina+1 ?>">Siguiente</a></li>
                    </ul>
                </nav> 
            </main>
