            ...
            <main class="main col">
                <div class="row justify-content-center align-content-center text-center">
                    <div class="col-sm-9" id="title">
                        <h3 class="mb-0 ">Editar Turnos</h3>
                    </div>
                    <br>
                    <?php
                ...
                try{
                    ...
                    $sql="SELECT  * from turnos  where  id_turno=:id";//consulta con marcador
                    ...
                    $resultado->execute(array(":id"=>$busca));
                        ...
                        if($turno=$resultado->fetch(PDO::FETCH_ASSOC)){
                                    ...
                                    <form method="post" action="validedit.php">
                                        ...
                                        <div class="col-auto">
                                            <div class="input-group col ">
                                                ...
                                                <input type="text" class="form-control"  name="turn" value="<?php echo $turno['turno']?>">
                                            </div>
                                         </div>
                                        <br>                                
                        ...
                        <?php
                                ...
                                echo "No existe este Turno $busca";
                            }
