...
require_once("../../connections/connection.php"); 
   ...
   no configurado, establecerá la página en 1. */
    ...
    /* Esta es una consulta a la base de datos para obtener todos los registros de la tabla "orden_ser". */
            ...
            <main class="main col">
                <div class="row justify-content-center align-content-center text-center">
                    <div class="col-sm-12" id="title">
                        <h3 class="mb-0 ">Historial Servicio</h3>
                    </div>
                </div>
                <br>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                             <!-- Botones Reportes -->
                            <a href="verorden/reporteorden.php"><button class="btn btn-success"><i class="fa-solid fa-file-excel"></i> Excel</button></a>
                            <a href="verorden/verordenpdf.php" target="blank"><button class="btn btn-danger"><i class="fa-solid fa-file-pdf"></i></button></a>           
                            <br> <br> 
                                        <!-- Filtro -->
                            ...
                            <div class="table-responsive" id="contenido">        
                                <table id="tablaRoles" class="table table-striped table-bordered table-condensed" style="width:100%">
                                    ...
                                    <tbody class="text-center" id="myTable">
                                        ...
                                        <tr class="table-light" >
                                            ...
                                            <td><?php echo $orden->fecha_ini_real?></td>
                                            <td><?php echo $orden->fecha_fin_real?></td>
                                                                         
                                            <td>
                                               <!-- Creando un enlace al archivo verorden.php. -->
                                                <a href="verorden/verorden.php?id=<?php echo $orden->id_auto?> & ser=<?php echo $orden->id_ser?>"><button type="button" title="Ver" class="btn btn-sm btn-primary"><i class="fa-solid fa-magnifying-glass"></i></button></a>
                                            </td>
                                        </tr>
                                        <?php
                                        endforeach;
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination justify-content-center">
                                        ...
                                        <!-- Creando un sistema de paginación para el sitio web. -->
                                        <?php
                                            for($i=0; $i<$paginas; $i++):?>
