        ...
        <div class="row ">
            ...
            <div class="barra-lateral col-12 col-sm-auto">
                <nav class="menu d-flex d-sm-block justify-content-center flex-wrap" >
                    ...
                    <a href="vehi.php"><i class="fa-solid fa-screwdriver-wrench"></i><span>Gestionar Vehículos</span></a>
                ...
                <div class="container">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="panel">
                                    <a href="sistema/crearuta.php"><div><button type="button" class="btn btn-blue tam1">Rutas</button></div></a>
                                </div>
                            </div>
                            <div class="col">
                                <div class="panel">
                                    <a href="sistema/turno.php"><div><button type="button" class="btn btn-blue tam1">Turnos</button></div></a>
                                </div>
                            </div>
                            <div class="col">
                                <div class="panel">
                                    <a href="sistema/tipvehi.php"><div><button type="button" class="btn btn-blue tam1">Tipo vehículos</button></div></a>
                                </div>
                            </div>
                            <div class="col">
                                <div class="panel">
                                    <a href="sistema/estadoveh.php"><div><button type="button" class="btn btn-blue tam1">Estado Vehículo</button></div></a>
                                </div>
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            <div class="col">
                                <div class="panel">
                                    <a href="sistema/marca.php"><div><button type="button" class="btn btn-blue tam1">Marcas</button></div></a>
                                </div>
                            </div>
                            
                            <div class="col">
                                <div class="panel">
                                    <a href="sistema/vinculo.php"><div><button type="button" class="btn btn-blue tam1">Vínculos</button></div></a>
                                </div>
                            </div>
                            <div class="col">
                                <div class="panel">
                                    <a href="sistema/modelo.php"><div><button type="button" class="btn btn-blue tam1">Modelo</button></div></a>
                                </div>
                            </div>
                            <div class="col">
                                <div class="panel">
