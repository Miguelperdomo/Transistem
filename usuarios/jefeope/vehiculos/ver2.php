<?php
   ...
   INNER JOIN estado ON regis_veh.id_est = estado.id_est
    ...
    /* Asignación de los valores de la base de datos a variables. */
    $placa = $regveh["placa"];
            ...
            <main class="main col">
                <div class="row justify-content-center align-content-center text-center">
                    <div class="col-sm-9" id="title">
                        <h3 class="mb-0 ">Ver Vehiculo</h3>
                    </div>
                    <br>
                        <div class="container center4">
                            <div class="modal-body">
                                <form>
                                    <div class="col-auto"><!-- Creación de un formulario con un campo de entrada de texto. -->
                                    ...
                                    <div class="col-auto">
                                        <div class="input-group col">
                                            ...
                                            <input type="date" class="form-control text-center" readonly name="fecha" value="<?php echo $fecha?>">
                                        </div>
                                    </div>
                                    <br>
                                    <div class="col-auto">
                                        <div class="input-group col ">
                                            ...
                                            <td>
                                                <input type="text" class="form-control text-center"  readonly name="tpvehiculo" value="<?php echo $tpvehi?>">
                                            </td>
                                        </div>
                                        </div>
                                    <br>
                                    ...
                                    <div class="col-auto">
                                        <div class="input-group col">
                                            ...
                                            <input type="text" class="form-control text-center" readonly name="chasis" value="<?php echo $chasis?>">
                                        </div>
                                    </div>
                                    <br>
                                    <div class="col-auto">
                                        <div class="input-group col">
                                            ...
                                            <input type="text" class="form-control text-center" readonly name="motor" value="<?php echo $motor?>">
                                        </div>
                                    </div>
                                    <br>
                                    <div class="col-auto">
                                        <div class="input-group col ">
                                            ...
                                            <td>
                                                <input type="text" class="form-control text-center"  readonly name="interno" value="<?php echo $interno?>">
                                            </td>
                                        </div>
                                        </div>
                                    <br>
                                    <div class="col-auto">
                                        <div class="input-group col ">
                                            ...
                                            <td>
                                                <input type="date" class="form-control text-center"  readonly name="tarjeta" value="<?php echo $vigenciatar?>">
                                            </td>
                                        </div>
                                        </div>
                                    <br>
                                    <div class="col-auto">
                                        <div class="input-group col ">
                                            ...
                                            <td>
                                                <input type="date" class="form-control text-center"  readonly name="soat" value="<?php echo $soat?>">
                                            </td>
                                        </div>
                                        </div>
                                    <br>
                                    <div class="col-auto">
                                        <div class="input-group col ">
                                            ...
                                            <td>
                                                <input type="date" class="form-control text-center"  readonly name="tecno" value="<?php echo $tecno?>">
                                            </td>
                                        </div>
                                        </div>
                                    <br>                            
                                    <div class="col-auto">
                                        <a href="yaasignados.php"><button type="button" class="btn btn-secondary">volver</button></a>
                                    </div>
                                </form>
                            </div>
                        </div>
