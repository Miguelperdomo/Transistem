<?php
   ...
   /*Una consulta a la base de datos. */
    $reg=$base->query("SELECT * from detalle_vehi, tipo_veh, usuarios, regis_veh, estado_asig where regis_veh.id_tip_veh=tipo_veh.id_tip_veh and detalle_vehi.placa=regis_veh.placa and detalle_vehi.id_usu=usuarios.id_usu and regis_veh.id_estvehi=estado_asig.id_estvehi and regis_veh.id_estvehi=1")->fetchALL(PDO::FETCH_OBJ);
?>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="main col">
                ...
                <br>
                <h4 class="text-center">Vehículos Asignados</h4>
                <br>
                <div class="container">
                    <div class="row">
...
<?php
    ...
    $dompdf->stream("vehiasig.pdf", array("Attachment" => false)); //Abre el archivo, pero en el navegador(false - no descarga)
?>