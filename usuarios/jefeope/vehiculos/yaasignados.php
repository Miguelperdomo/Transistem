...
require_once("../../../connections/connection.php"); 
   ...
   no configurado, establecerá la página en 1. */
    if(isset($_GET["pagina"])){
        if($_GET["pagina"]==1){
            header("Location:yaasignados.php");
        }else{
            $pagina=$_GET["pagina"];
        }
    }else{
  ...
  /* Cálculo del número de páginas. */
    ...
    $regis=$base->query("SELECT * from detalle_vehi, tipo_veh, usuarios, regis_veh, estado_asig where regis_veh.id_tip_veh=tipo_veh.id_tip_veh and detalle_vehi.placa=regis_veh.placa and detalle_vehi.id_usu=usuarios.id_usu and regis_veh.id_estvehi=estado_asig.id_estvehi LIMIT $empieza, $regis")->fetchALL(PDO::FETCH_OBJ);
?>
            ...
            <main class="main col">
                <div class="row justify-content-center align-content-center text-center">
                    <div class="col-sm-12" id="title">
                        <h3 class="mb-0 ">Vehículos Asignados</h3>
                    </div>
                    <!--Boton Registro-->
                </div>
                <br>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <!-- Botones Reportes  -->
                            <a href="reportea.php"><button class="btn btn-success"><i class="fa-solid fa-file-excel"></i> Excel</button></a>
                            <a href="vehiapdf.php" target="blank"><button class="btn btn-danger"><i class="fa-solid fa-file-pdf"></i></button></a>
                            <br><br> 
                                            <!-- Filtro -->
                                ...
                                <table id="tablaRoles" class="table table-striped table-bordered table-condensed" style="width:100%">
                                    ...
                                    <tbody class="text-center" id="myTable">
                                        ...
                                        <tr class="table-light" >
                                            ...
                                            <td><?php echo $vehiculos->nom_usu?></td>
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination justify-content-center">
                                        <li class="page-item <?php echo $pagina<=1? 'disabled' : '' ?>">
                                                <a class="page-link" href="yaasignados.php?pagina=<?php echo $pagina-1 ?>">Anterior</a>
                                        </li>
                                        <?php
                                            ...
                                            for($i=0; $i<$paginas; $i++):?>
                                                <li class="page-item <?php echo $pagina==$i+1? 'active': ''?>">
                                                    <a class="page-link" 
                                                    href="yaasignados.php?pagina=<?php echo $i+1?>">
                                                <?php echo $i+1?></a>
                                                </li>
                                                <?php endfor?>
                                        <li class="page-item <?php  echo $pagina>=$paginas? 'disabled' : '' ?> "><a class="page-link" href="yaasignados.php?pagina=<?php echo $pagina+1 ?>">Siguiente</a></li>
                                    </ul>
                                </nav> 
                            </div>
                        </div>
