...
require_once("../../../connections/connection.php"); 
   ...
   no configurado, establecerá la página en 1. */
    if(isset($_GET["pagina"])){
        if($_GET["pagina"]==1){
            header("Location:asignarcondu.php");
        }else{
            $pagina=$_GET["pagina"];
        }
    }else{
   ...
   /* Obtención de todos los datos de la base de datos. */
            ...
            <main class="main col">
                <div class="row justify-content-center align-content-center text-center">
                    <div class="col-sm-12" id="title">
                        <h3 class="mb-0 ">Vehículos por Asignar</h3>
                    </div>
                    <!--Boton Registro-->
                </div>
                <br>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <!-- Botones Reportes  -->
                            <a href="reporteasig.php"><button class="btn btn-success"><i class="fa-solid fa-file-excel"></i> Excel</button></a>
                            <a href="vehiasigpdf.php" target="blank"><button class="btn btn-danger"><i class="fa-solid fa-file-pdf"></i></button></a>
                            <br><br> 
                                            <!-- Filtro -->
                                ...
                                <table id="tablaRoles" class="table table-striped table-bordered table-condensed" style="width:100%">
                                    ...
                                    <tbody class="text-center" id="myTable">
                                        ...
                                        <tr class="table-light" >
                                            ...
                                            <!-- Creando un enlace a la página asigna.php y pasando el
                                            variables id y vin a la página.  -->
                                            <td>
                                                <a href="asigna.php?id=<?php echo $vehiculos->placa?> & vin=<?php echo $vehiculos->vinculo?>"><button type="button" title="Asignar Conductor" class="btn btn-sm btn-primary"><i class="fa-solid fa-id-card"></i></button></a>
                                            </td>
                                        </tr>
                                        <?php
                                        endforeach;
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination justify-content-center">
                                        <li class="page-item <?php echo $pagina<=1? 'disabled' : '' ?>">
                                                <a class="page-link" href="asignarcondu.php?pagina=<?php echo $pagina-1 ?>">Anterior</a>
                                        </li>
                                        <?php
                                           /*Creación de un sistema de paginación para la tabla. */
                                            for($i=0; $i<$paginas; $i++):?>
                                                <li class="page-item <?php echo $pagina==$i+1? 'active': ''?>">
                                                    <a class="page-link" 
                                                    href="asignarcondu.php?pagina=<?php echo $i+1?>">
                                                <?php echo $i+1?></a>
                                                </li>
                                                <?php endfor?>
                                        <li class="page-item <?php  echo $pagina>=$paginas? 'disabled' : '' ?> "><a class="page-link" href="asignarcondu.php?pagina=<?php echo $pagina+1 ?>">Siguiente</a></li>
                                    </ul>
                                </nav> 
                            </div>
                        </div>
