    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="main col">
                ...
                <br>
                <h4 class="text-center">Vehículo Registrados</h4>
                <br>
                <div class="container">
                    <div class="row">
...
<?php
   ...
   // instanciar y usar la clase dompdf
    ...
    $dompdf->stream("vehiculos.pdf", array("Attachment" => false)); //Abre el archivo, pero en el navegador(false - no descarga)
?>