<?php
   ...
   no configurado, establecerá la página en 1. */
    ...
    /* Esta es una consulta a la base de dato en la table solicitud y estado */
    $sql= 'SELECT * FROM solicitud, estado where solicitud.id_est=5 ';
            ...
            <main class="main col">
                <div class="row justify-content-center align-content-center text-center">
                    <div class="col-sm-12" id="title">
                        <h3 class="mb-0 ">Ordenes de servicio</h3>
                    </div>
                </div>
                <br>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <!-- Crear un botón que permitirá al usuario volver al anterior
                            página. -->
                                ...
                                <table id="tablaRoles" class="table table-striped table-bordered table-condensed" style="width:100%">
                                    ...
                                    <tbody class="text-center" id="myTable">
                                        ...
                                        <tr class="table-light" >
                                            ...
                                            <td>
                                               <!-- Creando un botón que te llevará a la página
                                               "orden/ver.php" y pasará el id de la orden y
                                               la identificación de la orden -->
                                                <a href="orden/ver.php?id=<?php echo $orden->id_soli?> & auto=<?php echo $orden->id_auto;?>"><button type="button" class="btn btn-sm btn-primary"><i class="fa-solid fa-magnifying-glass"></i></button></a>
                                            </td>
                                            <td>
                                               <!-- Creando un botón que llevará al usuario al
                                               página programar.php. -->
                                                <a href="orden/programar.php?id=<?php echo $orden->id_auto;?> & soli=<?php echo $orden->id_soli?> & email=<?php echo $orden->email?>"><button type="button" class="btn btn-sm btn-danger">Programar</button></a>
                                            </td>
                                        </tr>
                                        <?php
                                        endforeach;
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination justify-content-center">
                                        ...
                                        <li class="page-item <?php echo $pagina<=1? 'disabled' : '' ?>">
                                                <a class="page-link" href="verord.php?pagina=<?php echo $pagina-1 ?>">Anterior</a>
                                        </li>
                                        <li class="page-item <?php  echo $pagina>=$paginas? 'disabled' : '' ?> "><a class="page-link" href="verord.php?pagina=<?php echo $pagina+1 ?>">Siguiente</a></li>
                                    </ul>
                                </nav> 
                            </div>
                        </div>
