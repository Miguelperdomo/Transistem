    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="main col">
                ...
                <br>
                <br>
                <!-- Un div que contiene un contenedor que contiene una fila que contiene 3 columnas que
                contiene un panel que contiene un div que contiene un botón. -->
                <div class="container center12">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="panel">
                                    <a href="conductor/agregar.php"><div><button type="button" class="btn btn-blue tam1">Crear Conductores</button></div></a>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="panel">
                                    <a href="conductor/verconduct.php"><div><button type="button" class="btn btn-blue tam1">Ver Conductores</button></div></a>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="panel">
                                    <a href="conductor/activarconduct.php"><div><button type="button" class="btn btn-blue tam1">Activar Conductores</button></div></a>
                                </div>
                            </div>
                        </div>
                    </div> 
