            ...
            <main class="main col">
                <div class="row justify-content-center align-content-center text-center">
                    <div class="col-sm-9" id="title">
                        <h3 class="mb-0 ">Editar Modelo</h3>
                    </div>
                    <br>
            <?php
                ...
                try{
                    ...
                    $sql="SELECT  * from modelo where id_modelo=:id";//consulta con marcador, el marcador es :codigo
                    ...
                    $resultado->execute(array(":id"=>$busca));
                        ...
                        if($mode=$resultado->fetch(PDO::FETCH_ASSOC)){
                                    ...
                                    <form method="post" action="validar.php">
                                        ...
                                        <div class="col-auto">
                                            <div class="input-group col ">
                                                ...
                                                <input type="text" class="form-control" name="mode" value="<?php echo $mode['modelo']?>">
                                            </div>
                                        </div>
                                        <br>                                
                                        <div class="col-10">
