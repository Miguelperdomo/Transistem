        ...
        <div class="row">
            ...
            <?php
                ...
                try{
                    ...
                    $sql="SELECT  * from marcas where id_marca=:id";//consulta con marcador, el marcador es :codigo
                    ...
                    $resultado->execute(array(":id"=>$busca));
                        ...
                        if($mar=$resultado->fetch(PDO::FETCH_ASSOC)){
                                    ...
                                    <form method="post" action="validar.php">
                                        ...
                                        <div class="col-auto">
                                            <div class="input-group col ">
                                                ...
                                                <input type="text" class="form-control" name="mar" value="<?php echo $mar['marca']?>">
                                            </div>
                                        </div>
                                        <br>                                
                                        <div class="col-10">
