...
if(isset($_POST['insert'])){
   ...
   /* Insertando los valores de las variables y en la tabla de turnos. */
    $sql="INSERT INTO turnos (id_turno, turno) values (:id, :tur)";
    $resultado=$base->prepare($sql);
...
$regis = 4;
   ...
   /* Obteniendo los datos de la base de datos. */
    $regis=$base->query("SELECT * from turnos LIMIT $empieza, $regis")->fetchALL(PDO::FETCH_OBJ);
?>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Añadir Turnos</h5>
                                        ...
                                        <form method="post" autocomplete="off">
                                            ...
                                            <div class="col-auto">
                                                <div class="input-group col">
                                                    ...
                                                    <input type="text" required class="form-control" name="turn" >
                                                </div>
                                            </div>                                           
                                            <br>                                
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="table-responsive ">        
                                <table id="tablaRoles" class="table table-striped table-bordered table-condensed center3" style="width:50%">
                                    ...
                                    <tbody class="text-center">
                                        <?php
                                            ...
                                            /* Crear un ciclo foreach que recorrerá el
                                             matriz y asigne cada valor a la
                                            variable. */
                                            foreach ($regis as $turnos):
                                        ?> 
                                        <tr class="table-light" >
                                            <td><?php echo $turnos->id_turno?></td>
                                            <td><?php echo $turnos->turno?></td>
                                            <td>
                                                <a href="turno/edit.php?id=<?php echo $turnos->id_turno?> & nom=<?php echo $turnos->turno?>"><button type="button" class="btn btn-sm btn-blue"><i class="fa-solid fa-pen-to-square"></i></button></a>
                                            </td>
                                            <td>
                                                <a href="turno/delete.php?id=<?php echo $turnos->id_turno?> & nom=<?php echo $turnos->turno?>"><button type="button" class="btn btn-sm btn-danger"> <i class="fa-solid fa-trash-can"></i></button></a>
                                            </td>
                                        </tr>
                                        <?php
                                        endforeach;
                                ...
                                <!-- El código anterior está creando un sistema de paginación para una tabla.-->
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination justify-content-center">
                                        <li class="page-item <?php echo $pagina<=1? 'disabled' : '' ?>">
                                                <a class="page-link" href="turno.php?pagina=<?php echo $pagina-1 ?>">Anterior</a>
                                        </li>
                                        <?php
                                            for($i=0; $i<$paginas; $i++):?>
                                                <li class="page-item <?php echo $pagina==$i+1? 'active': ''?>">
                                                    <a class="page-link" 
                                                    href="turno.php?pagina=<?php echo $i+1?>">
                                                <?php echo $i+1?></a>
                                                </li>
                                                <?php endfor?>
                                        <li class="page-item <?php  echo $pagina>=$paginas? 'disabled' : '' ?> "><a class="page-link" href="turno.php?pagina=<?php echo $pagina+1 ?>">Siguiente</a></li>
                                    </ul>
                                </nav> 
                            </div>
                        </div>
