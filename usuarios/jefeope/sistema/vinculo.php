...
/* Comprobando si se hace clic en el botón. */
if(isset($_POST['insert'])){
    $id=$_POST['idr'];
    $vinculo=$_POST['vin'];

    /* Insertando los valores de las variables y en la tabla de turnos. */ 
    $sql="INSERT INTO vinculo (id_tip_vincu, vinculo) values (:id, :vin)";
    $resultado=$base->prepare($sql);
    $resultado->execute(array(":id"=>$id, ":vin"=>$vinculo));

    header("Location:vinculo.php");
}
...
$regis = 4;
   ...
   /* Obteniendo todos los datos de la tabla vinculo. */
    ...
    $regis=$base->query("SELECT * from vinculo LIMIT $empieza, $regis")->fetchALL(PDO::FETCH_OBJ);
?>
            ...
            <main class="main col">
                <div class="row justify-content-center align-content-center text-center">
                    <div class="col-sm-9" id="title">
                        <h3 class="mb-0 ">Tipo de vínculo vehículos</h3>
                    </div>
                    <br>
                    <!-- Modal Insertar -->                
                    <div class="container">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Añadir Vínculo</h5>
                                            ...
                                            <div class="col-auto">
                                                <div class="input-group col">
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text">Vínculo</div> 
                                                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="table-responsive ">        
                                    ...
                                    <tbody class="text-center">
                                        <?php
                                            /* Creando un bucle foreach que recorrerá el
                                             matriz y asigne cada valor a la
                                            variable.*/
                                            foreach ($regis as $vinculos):
                                        ?> 
                                        <tr class="table-light" >
                                            <td><?php echo $vinculos->id_tip_vincu?></td>
                                            <td><?php echo $vinculos->vinculo?></td>
                                            <td>
                                                <a href="vinculo/edit.php?id=<?php echo $vinculos->id_tip_vincu?> & nom=<?php echo $vinculos->vinculo?>"><button type="button" class="btn btn-sm btn-blue"><i class="fa-solid fa-pen-to-square"></i></button></a>
                                            </td>
                                            <td>
                                                <a href="vinculo/delete.php?id=<?php echo $vinculos->id_tip_vincu?> & nom=<?php echo $vinculos->vinculo?>"><button type="button" class="btn btn-sm btn-danger"> <i class="fa-solid fa-trash-can"></i></button></a>
                                            </td>
                                        </tr>
                                        <?php
                                        endforeach;
                                ...
                                <!-- El código anterior está creando un sistema de paginación para un sitio web. -->
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination justify-content-center">
                                        <li class="page-item <?php echo $pagina<=1? 'disabled' : '' ?>">
                                                <a class="page-link" href="vinculo.php?pagina=<?php echo $pagina-1 ?>">Anterior</a>
                                        </li>
                                        <?php
                                            for($i=0; $i<$paginas; $i++):?>
                                                <li class="page-item <?php echo $pagina==$i+1? 'active': ''?>">
                                                    <a class="page-link" 
                                                    href="vinculo.php?pagina=<?php echo $i+1?>">
                                                <?php echo $i+1?></a>
                                                </li>
                                                <?php endfor?>
                                        <li class="page-item <?php  echo $pagina>=$paginas? 'disabled' : '' ?> "><a class="page-link" href="vinculo.php?pagina=<?php echo $pagina+1 ?>">Siguiente</a></li>
                                    </ul>
                                </nav> 
                            </div>
                        </div>
...
<!-- El código anterior vincula los archivos bootstrap, jquery y popper.js al archivo html. -->
