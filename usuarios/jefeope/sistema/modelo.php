...
if(isset($_POST['insert'])){
    ...
    /* Insertar un nuevo registro en la tabla modelo. */
    $sql="INSERT INTO modelo (id_modelo, modelo) values (:id, :mo)";
    $resultado=$base->prepare($sql);
...
$regis = 4;
   ...
   /* Obteniendo todos los datos de la tabla modelo. */
    ...
    $regis=$base->query("SELECT * from modelo LIMIT $empieza, $regis")->fetchALL(PDO::FETCH_OBJ);
?>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Añadir Modelo</h5>
                                        ...
                                        <form method="post" autocomplete="off">
                                            ...
                                            <div class="col-auto">
                                                <div class="input-group col ">
                                                    ...
                                                    <input type="text" required class="form-control" name="mode" >
                                                </div>
                                            </div>
                                            <br>                                
                                ...
                                <table id="tablaRoles" class="table table-striped table-bordered table-condensed center3" style="width:50%">
                                    ...
                                    <tbody class="text-center">
                                        <?php
                                            ...
                                            variable.*/
                                            foreach ($regis as $modelo):
                                        ?> 
                                        <tr class="table-light" >
                                            <td><?php echo $modelo->id_modelo?></td>
                                            <td><?php echo $modelo->modelo?></td>
                                            <td>
                                                <a href="modelo/edit.php?id=<?php echo $modelo->id_modelo?> & nom=<?php echo $modelo->modelo?>"><button type="button" class="btn btn-sm btn-blue"><i class="fa-solid fa-pen-to-square"></i></button></a>
                                            </td>
                                            <td>
                                                <a href="modelo/delete.php?id=<?php echo $modelo->id_modelo?> & nom=<?php echo $modelo->modelo?>"><button type="button" class="btn btn-sm btn-danger"> <i class="fa-solid fa-trash-can"></i></button></a>
                                            </td>
                                        </tr>
                                        <?php
                                        endforeach;
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination justify-content-center">
                            <li class="page-item <?php echo $pagina<=1? 'disabled' : '' ?>">
                                    <a class="page-link" href="modelo.php?pagina=<?php echo $pagina-1 ?>">Anterior</a>
                            </li>
                            <?php
                                for($i=0; $i<$paginas; $i++):?>
                                    <li class="page-item <?php echo $pagina==$i+1? 'active': ''?>">
                                        <a class="page-link" 
                                        href="modelo.php?pagina=<?php echo $i+1?>">
                                    <?php echo $i+1?></a>
                                    </li>
                                    <?php endfor?>
                            <li class="page-item <?php  echo $pagina>=$paginas? 'disabled' : '' ?> "><a class="page-link" href="modelo.php?pagina=<?php echo $pagina+1 ?>">Siguiente</a></li>
                        </ul>
                    </nav> 
            </main>
