...
if(isset($_POST['insert'])){
    ...
    $sql="INSERT INTO tipo_veh (tip_veh, capaci_pasa) values (:tip, :cap)";
    $resultado=$base->prepare($sql);
    $resultado->execute(array(":tip"=>$tipo, ":cap"=>$capacidad));

    header("Location:tipvehi.php");
}
...
$regis = 4;
   ...
   no configurado, establecerá la página en 1. */
    ...
    /* Obteniendo todos los datos de la tabla tipo_veh. */
    ...
    $regis=$base->query("SELECT * from tipo_veh LIMIT $empieza, $regis")->fetchALL(PDO::FETCH_OBJ);
?>
            ...
            <main class="main col">
                <div class="row justify-content-center align-content-center text-center">
                    <div class="col-sm-9" id="title">
                        <h3 class="mb-0 ">Tipos de Vehículos</h3>
                    </div>
                    <br>
                    <!-- Modal Insertar -->
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Añadir Tipos vehículos</h5>
                                        ...
                                        <form method="post" autocomplete="off">
                                            ...
                                            <div class="col-auto">
                                                <div class="input-group col">
                                                    ...
                                                    <input type="text" required class="form-control" name="tip" >
                                                </div>
                                            </div>
                                            <br>
                                            <div class="col-auto">
                                                <div class="input-group col ">
                                                    ...
                                                    <input type="number" required class="form-control" name="cap" >
                                                </div>
                                            </div>
                                            <br>                                
                                    ...
                                    <tbody class="text-center">
                                        <?php
                                           ...
                                           matriz y asigne cada valor a la variable.*/
                                            foreach ($regis as $tipve):
                                        ?> 
                                        <tr class="table-light" >
                                            <td><?php echo $tipve->id_tip_veh?></td>
                                            <td><?php echo $tipve->tip_veh?></td>
                                            <td><?php echo $tipve->capaci_pasa?></td>
                                            <td>
                                                <a href="tipveh/edit.php?id=<?php echo $tipve->id_tip_veh?> & nom=<?php echo $tipve->tip_veh?>"><button type="button" class="btn btn-sm btn-blue"><i class="fa-solid fa-pen-to-square"></i></button></a>
                                            </td>
                                            <td>
                                                <a href="tipveh/delete.php?id=<?php echo $tipve->id_tip_veh?> & nom=<?php echo $tipve->tip_veh?>"><button type="button" class="btn btn-sm btn-danger"> <i class="fa-solid fa-trash-can"></i></button></a>
                                            </td>
                                        </tr>
                                        <?php
                                        endforeach;
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination justify-content-center">
                                        <li class="page-item <?php echo $pagina<=1? 'disabled' : '' ?>">
                                                <a class="page-link" href="tipvehi.php?pagina=<?php echo $pagina-1 ?>">Anterior</a>
                                        </li>
                                        <?php
                                            for($i=0; $i<$paginas; $i++):?>
                                                <li class="page-item <?php echo $pagina==$i+1? 'active': ''?>">
                                                    <a class="page-link" 
                                                    href="tipvehi.php?pagina=<?php echo $i+1?>">
                                                <?php echo $i+1?></a>
                                                </li>
                                                <?php endfor?>
                                        <li class="page-item <?php  echo $pagina>=$paginas? 'disabled' : '' ?> "><a class="page-link" href="tipvehi.php?pagina=<?php echo $pagina+1 ?>">Siguiente</a></li>
                                    </ul>
                                </nav> 
                            </div>
                        </div>
