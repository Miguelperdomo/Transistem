            ...
            <main class="main col">
                <div class="row justify-content-center align-content-center text-center">
                    <div class="col-sm-9" id="title">
                        <h3 class="mb-0 ">Editar Tipos de Vehículos</h3>
                    </div>
                    <br>
                    <?php
                ...
                $busca=$_GET["id"];
                    ...
                    $sql="SELECT  * from tipo_veh  where  id_tip_veh=:id";//consulta con marcador, el marcador es :codigo
                    ...
                    $resultado->execute(array(":id"=>$busca));
                        ...
                        if($tip=$resultado->fetch(PDO::FETCH_ASSOC)){
                                    ...
                                    <form method="post" action="validedit.php">
                                        ...
                                        <div class="col-auto">
                                            <div class="input-group col ">
                                                ...
                                                <input type="text" class="form-control"  name="tip" value="<?php echo $tip['tip_veh']?>">
                                            </div>
                                         </div>
                                        <br>
                                        <div class="col-auto">
                                            <div class="input-group col ">
                                                ...
                                                <input type="text" class="form-control"  name="cap" value="<?php echo $tip['capaci_pasa']?>">
                                            </div>
                                         </div>
                                        <br>                                
