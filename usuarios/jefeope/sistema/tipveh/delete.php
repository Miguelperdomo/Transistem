            ...
            <main class="main col">
                <div class="row justify-content-center align-content-center text-center">
                    <div class="col-sm-9" id="title">
                        <h3 class="mb-0 ">Eliminar Tipo Vehículo</h3>
                    </div>
                    <br>
                    <?php
	                $busca=$_GET["id"];
                    ...
                    try{
                        ...
                        $sql= "SELECT * FROM regis_veh where id_tip_veh = :de"; 
                        $resultado=$base->prepare($sql);
                        ...
                        if($ele){
                            ...
                            <div class="container">
                                <a href="../tipvehi.php"><button type="button" class="btn btn-secondary">Volver</button></a>
                            </div>';
                        }
                        else{

                            $sql= "SELECT * FROM tipo_veh where id_tip_veh = $busca"; 
                            $resultado=$base->prepare($sql);
                            $resultado->execute(array());
                            $tip=$resultado->fetch(PDO::FETCH_ASSOC);   

                            $id=$tip['id_turno'];

                            if(isset($_POST['eliminar'])){

                                $sql="DELETE FROM tipo_veh WHERE id_tip_veh=:id";
                                ...
                                echo '<script>alert("Haz Eliminado este Tipo Vehículo.");</script>';
                                ...
                                <form method="post">
                                    <div class="col-auto">
                                        <div class="input-group col">
                                            ...
                                            <input type="text" class="form-control" readonly name="idr" value="<?php echo $tip['id_tip_veh']?>">
                                        </div>
                                    </div>
                                    <br>
                                    <div class="col-auto">
                                        <div class="input-group col ">
                                            ...
                                            <input type="text" class="form-control" readonly name="tip" value="<?php echo $tip['tip_veh']?>">
                                        </div>
                                    </div>
                                    <br>
                                    <div class="col-auto">
                                        <div class="input-group col ">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">Capacidad Pasajeros</div>
                                            </div>
                                            <input type="text" class="form-control" readonly name="cap" value="<?php echo $tip['capaci_pasa']?>">
                                        </div>
                                    </div>
                                    <br>                                 
                                    <div class="modal-footer">
                                        <a href="../tipvehi.php"><button type="button" class="btn btn-secondary">Cancelar</button></a>
