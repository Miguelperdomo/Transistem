            ...
            <main class="main col">
                <div class="row justify-content-center align-content-center text-center">
                    <div class="col-sm-9" id="title">
                        <h3 class="mb-0 ">Eliminar Estado Vehiculo</h3>
                    </div>
                    <br>
            <?php
	            $busca=$_GET["id"];
                try{
                    ...
                    $sql= "SELECT * FROM estado_asig, usuarios WHERE usuarios.id_estvehi=estado_asig.id_estvehi and estado_asig.id_estvehi= $busca"; 
                    $resultado=$base->prepare($sql);
                    $resultado->execute(array());
                    $usu=$resultado->fetch(PDO::FETCH_ASSOC);

                    $sql= "SELECT * FROM estado_asig, regis_veh WHERE regis_veh.id_estvehi=estado_asig.id_estvehi and estado_asig.id_estvehi= $busca"; 
                    $resultado=$base->prepare($sql);
                    $resultado->execute(array());
                    ...
                    if($usu){
                        ...
                        <div class="container">
                            <a href="../estadoveh.php"><button type="button" class="btn btn-secondary">Volver</button></a>
                        </div>';
                    }
                        ...
                        $sql="SELECT  * from estado_asig  where id_estvehi=:id";//consulta con marcador 
                        ...
                        if(isset($_POST['eliminar'])){
                            ...
                            $sql="DELETE FROM estado_asig WHERE id_estvehi=:id";
                                ...
                                <form method="post">
                                    <div class="col-auto">
                                        <div class="input-group col">
                                            ...
                                            <input type="text" class="form-control" readonly name="id" value="<?php echo $estado['id_estvehi']?>">
                                        </div>
                                    </div>
                                    <br>
                                    <div class="col-auto">
                                        <div class="input-group col ">
                                            ...
                                            <input type="text" class="form-control" readonly name="mar" value="<?php echo $estado['estvehi']?>">
                                        </div>
                                    </div>
                                    <br>                                
                                    <div class="col-10">
                                        <a href="../estadoveh.php"><button type="button" class="btn btn-secondary">Cancelar</button></a>
