            ...
            <main class="main col">
                <div class="row justify-content-center align-content-center text-center">
                    <div class="col-sm-9" id="title">
                        <h3 class="mb-0 ">Editar Estado Vehiculo</h3>
                    </div>
                    <br>
            <?php
                ...
                try{
                    ...
                    $sql="SELECT  * from estado_asig where id_estvehi=:id";//consulta con marcador, el marcador es :codigo
                    ...
                    $resultado->execute(array(":id"=>$busca));
                        ...
                        if($estado=$resultado->fetch(PDO::FETCH_ASSOC)){
                                    ...
                                    <form method="post" action="validar.php">
                                        ...
                                        <div class="col-auto">
                                            <div class="input-group col ">
                                                ...
                                                <input type="text" class="form-control" name="mar" value="<?php echo $estado['estvehi']?>">
                                            </div>
                                        </div>
                                        <br>                                
                                        <div class="col-10">
