<?php
    ...
    $orden=$solicitud['id_auto'];
    $detavehi=$solicitud['id_detave']; 
     
    /* Una consulta a la base de datos. */
    $regis=$base->query("SELECT * from detalle_ord, detalle_vehi, solicitud, regis_veh, marcas, tipo_veh, usuarios where detalle_ord.id_detave=detalle_vehi.id_detave and detalle_ord.id_soli=solicitud.id_soli and detalle_vehi.placa=regis_veh.placa and regis_veh.id_marca=marcas.id_marca and regis_veh.id_tip_veh=tipo_veh.id_tip_veh and detalle_vehi.id_usu=usuarios.id_usu and detalle_ord.id_detave=$detavehi")->fetchALL(PDO::FETCH_OBJ);
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="main col">
                ...
                <br>
                <h4 class="text-center">Detalle Orden N. <?php echo $orden;?> </h4>
                <br>
                <div class="container">
                    <div class="row">                        
                                ...
                                <table id="tablaRoles" class="table table-striped table-bordered table-condensed" style="width:100%">
                                    ...
                                    <tbody class="text-center">
                                        ...
                                        <tr class="table-light" >
                                            ...
                                            base de datos. -->
                                            <td><?php echo $solicitud->id_detave?></td>
                                            <td><?php echo $solicitud->id_soli?></td>                             
                                            <td><?php echo $solicitud->nom_usu?></td>
                                            <td><?php echo $solicitud->tip_veh?></td>
                                            <td><?php echo $solicitud->capaci_pas?></td>
...
<?php
   /* Obtener el contenido del búfer y asignarlo a la variable ``. */
    ...
    $dompdf->stream("solitrami.pdf", array("Attachment" => false)); //Abre el archivo, pero en el navegador(false - no descarga)
?>