        ...
        <div class="row">
            ...
            <main class="main col">
                <div class="row justify-content-center align-content-center text-center">
                    ...
                    <br>
                    <?php
                    /* Tratando de obtener el id de la url. */
                    $busca=$_GET["id"];
        
                    $sql= "SELECT * FROM usuarios, detalle_vehi where detalle_vehi.id_usu = usuarios.id_usu and usuarios.id_usu=$busca"; 
                    $resultado=$base->prepare($sql);
                    $resultado->execute(array());
                    ...
                    if($regusu){
                            echo '<br><div class="alert alert-danger center4"> No se puede eliminar este Usuario. Asociado a vehículo
                            </div><br>
                            <div class="container">
                            <a href="verconduct.php"><button type="button" class="btn btn-secondary">Volver</button></a>
                            </div>';
                    }
                    else{
