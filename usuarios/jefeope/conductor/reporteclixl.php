<?php
 /* El código que se conecta a la base de datos. */
    ...
    $sql="SELECT * from usuarios, rol, estado, tipo_cliente, ident where usuarios.id_rol=rol.id_rol and usuarios.id_est=estado.id_est and usuarios.id_tip_clien=tipo_cliente.id_tip_clien and usuarios.id_ident=ident.id_ident and usuarios.id_rol=4 and usuarios.id_est=1";
    $resultado=$base->prepare($sql);
    $resultado->execute(array());
    
    /* Crear una nueva hoja de cálculo y establecer el título de la hoja activa. */
    $excel = new Spreadsheet() ;
    $hojaActiva = $excel-> getActiveSheet();
    $hojaActiva->setTitle("Conductores Activos");
    ...
    /* Un bucle while que obtiene los datos de la base de datos y luego establece los valores en Excel
    sábana. */
