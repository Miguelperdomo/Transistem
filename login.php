<?php
    ...
    if(isset($_POST['insert'])){
        ...
        if (empty($_POST['doc']) || empty($_POST['tip']) || empty($_POST['ident']) || empty($_POST['nom']) || empty($_POST['cla']) || empty($_POST['dir']) || empty($_POST['tel']) || empty($_POST['emai'])){
...
<div class="container" id="container">
	<div class="form-container sign-up-container">
        <!-- Formulario de registro de clientes nuevos -->
		<form method="POST" id="form" autocomplete="off">
			...
			<input type="text" name="text" id="email" placeholder="Email" />
	...
	<div class="form-container sign-in-container">
		<form method ="POST" name=formlog action="includes/inicio.php" id="segundo" autocomplete="off">
            <img src="img/puriesturlogo.png" alt="logo" width="120px">
            <br>
			<h1>Iniciar sesión</h1>
            <br>
			<input type="number" name="id" id="doc" placeholder="Documento"/>
